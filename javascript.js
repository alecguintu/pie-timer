...
function drawTimer(percent) {
  $('div.timer').html('<div class="percent"></div><div class="closer"></div><div class="closer filler"></div><div class="slice'+(percent > 50 ? ' gt50' : '')+'"><div class="pie"></div>'+(percent > 50 ? '<div class="pie fill"></div>' : '')+'</div>');
...
$(document).ready(function(){
  ...
  drawTimer($('.timer .percent').attr('data-percent'));
});
